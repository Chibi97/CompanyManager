    ...
    <div class="section__content section__content--p30 manage-users">
        <div class="container-fluid">
            <div class="row update-wrapper">
                <div class="the-card col-12 col-md-8 col-lg-8">
                    <div class="au-card chart-percent-card">
                        <form id="addNewTask" action="" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="startDate" name="start_date" type="date" class="form-control" value="">
                            </div>

                            <div class="form-group">
                                <label for="endDate" class="control-label mb-1">End date</label>
                                <input id="endDate" name="end_date" type="date" class="form-control" value="">
                            </div>

                            <div class="form-group">
                                <label for="num" class="control-label mb-1">Number of employees</label>
                                <input id="num" name="count" type="number" min="1" class="form-control" value="1">
                            </div>

                            <div class="form-group">
                                <label class="control-label mb-1">Assign employees to the task</label>
                                <select class="selectMultipleUsers" multiple style="width: 75%"
                                        name="employees[]">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control ml-0">
